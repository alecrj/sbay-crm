-- Fix the create_property_with_calendar function to match actual database schema
...
BEGIN
  ...
  -- Using the correct column names: is_active instead of is_available, and slot_duration
  INSERT INTO calendar_availability (
    ...
    (new_property_id, 1, '09:00:00', '17:00:00', 30, true),  -- Monday
    (new_property_id, 2, '09:00:00', '17:00:00', 30, true),  -- Tuesday
    (new_property_id, 3, '09:00:00', '17:00:00', 30, true),  -- Wednesday
    (new_property_id, 4, '09:00:00', '17:00:00', 30, true),  -- Thursday
    (new_property_id, 5, '09:00:00', '17:00:00', 30, true);  -- Friday
